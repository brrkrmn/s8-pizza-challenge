...
const Success = ({ orderDetails }) => {
  ...
  return (
    <div className="bg-red min-h-screen w-full px-4 pt-0 mobile:pt-7 pb-20 flex flex-col items-center justify-start gap-10 text-white">
      ...
      >
        <h3 id="order-title" className="text-2xl font-barlow font-semibold">
          {itemName}
        </h3>
      ...
      <aside
        ...
        className="p-10 w-full max-w-80 flex items-start jusify-center gap-4 flex-col border-1 border-white rounded-sm"
      >
        <p id="total-label" className="text-xl font-semibold">
          Sipariş Toplamı
        </p>
